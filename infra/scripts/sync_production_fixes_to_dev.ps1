...
$files = @(
    ...
    "src\active_draws\local_ocr_extractor.py",
    ...
    "tests\test_local_ocr_extractor.py",
    "tests\test_ai_runtime_credentials.py",
...
try {
    ...
    $gitFiles = @(
        ...
        "tests/test_local_ocr_extractor.py",
        "tests/test_ai_runtime_credentials.py",
