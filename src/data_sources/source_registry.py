...
TRUSTED_WEB_SOURCES: tuple[WebSource, ...] = (
    ...
    WebSource(
        "espn_scoreboard_soccer",
        "ESPN Scoreboard - Futbol",
        "https://site.api.espn.com/apis/site/v2/sports/soccer/mex.1/scoreboard",
        "sports_data_api",
        82,
        ("progol", "progol_revancha", "progol_media_semana"),
        ("fixtures", "market_line", "results"),
        "public_json_best_effort",
        "Fuente publica complementaria para partidos estructurados cuando Pronosticos publica el volante como imagen.",
    ),
    WebSource(
        "espn_scoreboard_football",
        "ESPN Scoreboard - NFL/NCAA",
        ...
        ("fixtures", "market_line", "results"),
        "public_json_best_effort",
        "Fuente publica complementaria para partidos estructurados de futbol americano.",
    ),
    WebSource(
        "bet365_football",
